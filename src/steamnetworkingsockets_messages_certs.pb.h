...
class CMsgSteamNetworkingIdentity : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:CMsgSteamNetworkingIdentity) */ {
 public:
  ...
  inline CMsgSteamNetworkingIdentity* New() const final {
    return CreateMaybeMessage<CMsgSteamNetworkingIdentity>(NULL);
  }
...
inline const ::CMsgSteamNetworkingIdentity& CMsgSteamDatagramCertificate::_internal_identity() const {
  return *identity_;
}
